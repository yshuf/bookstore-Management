<template>
  <div class="page_container">个人中心页面</div>
</template>
...
// 				</div>
// 				<div class="title">
// 					<p class="title_welcome">您好，<span>{{userName}}</span>，欢迎来到邢易融绿色金融综合服务平台</p>
// 					<p class="title_introduce">平台介绍 &nbsp;&nbsp;|&nbsp;&nbsp; “一站式”解决中小企业“融资难，融资贵，融资慢”的问题，实现金融领域“最多跑一次”</p>
// 				</div>
// 			</div>
// 		</div>
...
// 						<span class="right-txt">{{userInfo.phone}} <i class="iconfont icon-bianjixiugai" title="修改手机号"
// 																	  @click="orgEdit('修改手机号','resetPhone',resetPhone)"></i></span>
// 					</div>
// 					<div class="left-list">
// 						<span class="left-txt">登录密码：</span>
// 						<span class="right-txt">{{userInfo.password}}<i class="iconfont icon-bianjixiugai" title="修改密码"
// 																		@click="orgEdit('修改密码','resetPass',resetPass)"></i></span>
// 					</div>
// 					<div class="left-list">
...
// 			<div class="personalInfo-content">
// 				<div class="personalInfo-title">
// 					机构信息<span class="personalInfo-title-state">已审核</span>
// 				</div>
// 				<div class="personalInfo-introduce">
// 					<div class="left-list">
...
// 					<div class="instruction-list-item" v-for="(item, i) in instructionList.filter(item => item.type != 6)" :key="i" @click="getInstruction(item.type, item.content)">
// 						<span class="order">{{i + 1}}</span><span class="article">{{item.title}}</span>
// 					</div>
// 				</div>
// 			</div>
// 		</div>
...
// 							<input class="text input-border" type="tel" placeholder="请输入11位新手机号"
// 								   v-model="modelData.data.phone" maxlength="11"/>
...
// 						<div class="input-text">
// 							<input type="number" class="text input-border" placeholder="请输入验证码"
// 								   v-model="modelData.data.smsCode" oninput="if(value.length>6)value=value.slice(0,6)">
// 						</div>
// 					</div>
...
// 						<div class="input-text">
// 							<input type="text" placeholder="请输入旧密码" class="text input-border"
...
// 						<div class="input-text">
// 							<input type="text" placeholder="请输入新密码" class="text input-border"
...
// 						<div class="input-text">
// 							<input type="text" placeholder="请再次输入密码" class="text input-border"
...
// 			display: flex;
// 			align-items: center;
// 			background: #fff url("../../../static/images/inst/business-bg.png") bottom right no-repeat;
